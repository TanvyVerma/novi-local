...
export default function Footer() {
  return (
    <footer className="relative pt-8 pb-12 px-6 lg:px-12 overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          <div className="col-span-2 space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-primary to-accent text-white flex items-center justify-center font-bold text-base">
                N
              </div>
              <span
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-foreground/50">
              <li><Link href="/for-students" className="hover:text-primary transition-colors">How It Works</Link></li>
              <li><Link href="/for-students" className="hover:text-primary transition-colors">Career Explorer</Link></li>
              <li><Link href="/for-students" className="hover:text-primary transition-colors">University Explorer</Link></li>
              <li><Link href="/coming-soon" className="hover:text-primary transition-colors">AI Roadmap</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-foreground/50">
              <li><Link href="/for-parents" className="hover:text-primary transition-colors">Parent Dashboard</Link></li>
              <li><Link href="/for-parents" className="hover:text-primary transition-colors">How We Help</Link></li>
              <li><Link href="/for-parents" className="hover:text-primary transition-colors">Resources</Link></li>
        ...
        <div className="mt-10 pt-6 border-t border-foreground/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div className="w-full max-w-xs space-y-2">
            ...
            <div className="flex items-center rounded-full border border-foreground/10 bg-background/50 focus-within:border-primary transition-colors overflow-hidden">
              <input
                type="email"
