...
const universities = [
  { name: "Stanford", color: "from-red-500 to-red-600", emoji: "🌲", match: 97, category: "STEM", glow: "#ef4444" },
  { name: "MIT", color: "from-red-600 to-red-700", emoji: "⚡", match: 95, category: "STEM", glow: "#dc2626" },
  { name: "Harvard", color: "from-rose-800 to-rose-900", emoji: "📚", match: 91, category: "Humanities", glow: "#be123c" },
  { name: "Oxford", color: "from-blue-700 to-blue-800", emoji: "🎓", match: 89, category: "Humanities", glow: "#1d4ed8" },
  { name: "Cambridge", color: "from-blue-600 to-blue-700", emoji: "🏛️", match: 88, category: "STEM", glow: "#2563eb" },
  { name: "NUS", color: "from-orange-500 to-orange-600", emoji: "🌏", match: 84, category: "Business", glow: "#f97316" },
  { name: "Imperial", color: "from-cyan-600 to-cyan-700", emoji: "🔬", match: 92, category: "STEM", glow: "#0891b2" },
  { name: "NYU", color: "from-indigo-500 to-indigo-600", emoji: "🏙️", match: 81, category: "Business", glow: "#6366f1" },
]
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-center text-center my-6 relative z-10">
                    ...
                    <motion.div 
                      ...
                      className="w-20 h-20 rounded-2xl flex items-center justify-center text-4xl mb-5 shadow-xl"
                      style={{ background: `linear-gradient(135deg, ${universities[activeIndex].glow}, #000)`, boxShadow: `0 10px 30px -5px ${universities[activeIndex].glow}40` }}
                    >
                      {universities[activeIndex].emoji}
                    </motion.div>
