...
import { CheckCircle2, ShieldCheck, ArrowUpRight, TrendingUp } from "lucide-react";
...
export default function ForParents() {
  ...
  return (
    <section id="for-parents" className="relative py-28 px-6 lg:px-12 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-foreground/60 leading-relaxed max-w-xl">
              Stay fully informed without micromanaging. Novi provides real-time telemetry into
              your child&apos;s growth, university alignment, and key milestones.
            </p>
          ...
          >
            <ParentHubCard>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="p-4 rounded-2xl bg-background/30 border border-foreground/5 space-y-2">
                  ...
                  <div
                    ...
                    className={`cursor-pointer flex items-center justify-between p-3.5 rounded-xl border transition-all duration-200 ${
                      activeFocus === idx
                        ...
                        : "bg-background/20 border-foreground/5 hover:border-foreground/10"
                    }`}
                  >
                    ...
                    <span className="text-[10px] font-mono font-semibold text-foreground/40 px-2 py-0.5 rounded bg-foreground/5">
                      {goal.category}
                    </span>
                  </div>
                ))}
