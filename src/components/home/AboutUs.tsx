          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center p-6 sm:p-8">
            ...
            <div className="relative z-10 order-1 lg:order-2">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center gap-6">
                <button className="btn-primary group w-full lg:w-auto justify-center">
                  Start your journey 
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            ...
            <div className="col-span-2">
              ...
              <div className="flex items-center gap-4">
                <a href="#" aria-label="Instagram" className="w-9 h-9 rounded-full border border-black/10 dark:border-foreground/10 flex items-center justify-center hover:border-primary/30 hover:text-primary transition-colors">
                ...
                <a href="#" aria-label="YouTube" className="w-9 h-9 rounded-full border border-black/10 dark:border-foreground/10 flex items-center justify-center hover:border-primary/30 hover:text-primary transition-colors">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/></svg>
                </a>
                <a href="#" aria-label="LinkedIn" className="w-9 h-9 rounded-full border border-black/10 dark:border-foreground/10 flex items-center justify-center hover:border-primary/30 hover:text-primary transition-colors">
                ...
                <a href="#" aria-label="Twitter" className="w-9 h-9 rounded-full border border-black/10 dark:border-foreground/10 flex items-center justify-center hover:border-primary/30 hover:text-primary transition-colors">
            ...
            <div>
              ...
              <form className="flex items-center rounded-full border border-black/10 dark:border-foreground/10 bg-background/50 focus-within:border-primary/50 transition-colors overflow-hidden">
                <input 
                  type="email" 
                  placeholder="Enter your email" 
                  className="flex-1 bg-transparent px-4 py-2.5 text-sm outline-none placeholder:text-foreground/50"
                />
                <button 
                  type="submit" 
