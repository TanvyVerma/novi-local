          ...
          >
            ...
            >
              <Magnetic strength={12}>
                <Link href="/signin" className="btn-primary group relative overflow-hidden w-full sm:w-auto justify-center">
              ...
              <Magnetic strength={16}>
                <Link href="/parents" className="btn-secondary group w-full sm:w-auto justify-center">
