...
import FloatingOrb3D from '../components/3d/FloatingOrb'
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 pt-28 pb-16 w-full relative z-10">
        <div className="grid lg:grid-cols-2 gap-14 lg:gap-8 items-center">
          ...
          >
            ...
            >
              <Magnetic strength={12}>
                <Link href="#how-it-works" className="btn-primary group relative overflow-hidden">
              ...
              <Magnetic strength={16}>
                <Link href="#for-students" className="btn-secondary group">
          ...
          {/* Right Side - 3D Avatar with Mouse Tracking */}
          <motion.div 
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
          ...
          >
            <div className="relative w-full aspect-square max-w-[620px] mx-auto">
              ...
              {/* Animated Avatar with Mouse Tracking */}
              <motion.div
                style={{ 
              ...
              {showChat && (
                <motion.div 
                  ...
                  className="absolute -top-5 right-0 sm:-top-10 sm:right-0 z-20"
                >
                  <div className="glass-card rounded-2xl p-4 max-w-[280px] backdrop-blur-xl border border-white/10 shadow-2xl">
                    <div className="flex items-start gap-3">
              ...
              <motion.div 
                ...
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.8 }}
                className="absolute top-[20%] left-[-20px] animate-float"
              >
                <div className="glass-card rounded-2xl px-4 py-3 flex items-center gap-3 shadow-xl border border-white/10 backdrop-blur-xl">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-foreground">Interest discovered</p>
                    <p className="text-[11px] text-foreground/50">Technology + Problem Solving</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div 
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 1 }}
                className="absolute bottom-[12%] left-[-10px] animate-float delay-500"
              >
                <div className="glass-card rounded-2xl px-4 py-3 shadow-xl border border-white/10 backdrop-blur-xl">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-6 h-6 rounded-lg bg-blue-500/20 flex items-center justify-center">
                      <span className="text-[10px] text-blue-400 font-bold">4Y</span>
                    </div>
                    <span className="text-xs font-semibold text-foreground">Your journey</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    {["9", "10", "11", "12"].map((grade, index) => (
                      <div key={grade} className="flex items-center">
                        <div className={`w-6 h-6 rounded-full flex items-center justify-center text-[9px] font-bold ${index === 0 ? "bg-gradient-to-r from-purple-500 to-pink-500 text-white" : "bg-purple-500/10 text-purple-400"}`}>
                          {grade}
                        </div>
                        {index < 3 && <div className="w-3 h-px bg-purple-500/20" />}
                      </div>
                    ))}
                  </div>
                </div>
      ...
      <motion.div 
        ...
        className="relative w-full bg-gradient-to-r from-purple-500/10 via-blue-500/5 to-purple-500/10 border-y border-purple-500/20 py-3.5 overflow-hidden"
      >
