  ...
  return (
    <section id="about-us" className="relative pt-8 pb-12 px-6 overflow-hidden bg-background">
      <div className="max-w-[1400px] mx-auto">
        ...
        <footer className="mt-8 pt-6 border-t border-black/10 dark:border-white/10">
          ...
          <div className="mt-8 pt-6 border-t border-black/10 dark:border-white/10 text-center text-sm text-foreground/40">
